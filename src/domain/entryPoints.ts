// The two ways into Canvas: the button ids index.js registers with the
...
/** The lasso-toolbar "Open Canvas" button; opens the canvas behind a lassoed Canvas thumbnail (FR13). */
