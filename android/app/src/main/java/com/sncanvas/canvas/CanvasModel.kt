...
/*
 * Canvas's domain model: world-space value types (PRD §8). Pure Kotlin, no
 * Android types, so the model, CanvasCore's operations on it, the fit
 ...
 * positions are resolved live by CanvasCore.resolveArrowEndpoints and never
 ...
 * [CanvasView]'s draw routines consume. Produced for the live view, the
...
/** What a [CanvasCore.handleAt] hit-test found under a touch point. */
