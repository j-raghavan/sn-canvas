...
import {backBadgeTaps, buildCanvasSession, hostButtonEvents} from './src/wiring';
...
export default function App(): React.JSX.Element {
  return <CanvasScreen createSession={buildCanvasSession} buttonEvents={hostButtonEvents} backBadgeTaps={backBadgeTaps} />;
}
